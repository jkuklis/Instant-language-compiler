...
/* package instester-0.2 */
#ifndef VERSION_instester
#define VERSION_instester "0.2"
#endif /* VERSION_instester */
#ifndef MIN_VERSION_instester
#define MIN_VERSION_instester(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  2 || \
  (major1) == 0 && (major2) == 2 && (minor) <= 0)
#endif /* MIN_VERSION_instester */
...
/* package shelly-1.7.2 */
#ifndef VERSION_shelly
#define VERSION_shelly "1.7.2"
...
#define CURRENT_COMPONENT_ID "instester-0.2-AmOqhYtnUWOI8l19oeuC5x-instester"
